# -*- coding: utf-8 -*-
#
# OKF Operations Manual build configuration file, created by
...
extensions = ['sphinx.ext.todo', 'edit_on_github']
...
htmlhelp_basename = 'OKFOperationsManualdoc'
...
latex_documents = [
  ('index', 'OKFOperationsManual.tex', u'OKF Operations Manual',
...
man_pages = [
    ('index', 'okfopsmanual', u'OKF Operations Manual',
...
texinfo_documents = [
  ('index', 'OKFOperationsManual', u'OKF Operations Manual',
   u'Open Knowledge Foundation', 'OKFOperationsManual', 'Guides and documentation for Open Knowledge Foundation perations and infrastructure',
   'Miscellaneous'),
]
...
edit_on_github_project = 'okfn/opsmanual'
